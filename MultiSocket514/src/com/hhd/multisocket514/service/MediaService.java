package com.hhd.multisocket514.service;
...
public class MediaService extends Service implements OnCompletionListener, OnSeekCompleteListener, OnErrorListener {
	...
	public void onStart(Intent intent, int startId) {
		...
		switch (option) {
			...
			case MusicConstantValue.OPTION_CONTINUE:
				...
				MediaUtil.PLAYSTATE = option;
				break;
			case MusicConstantValue.OPTION_UPDATE_PROGESS:
				playerToPosiztion(postion);
				break;
		}
	}
	...
	public void onCompletion(MediaPlayer arg0) {
		HandlerManager.getHandler().sendEmptyMessage(MusicConstantValue.PLAY_END);
	}
	...
	private class ProgressTask extends AsyncTask<Void, Void, Void> {
		...
		protected void onProgressUpdate(Void... values) {
			if (player.isPlaying()) {
				...
				msg.what = MusicConstantValue.SEEKBAR_CHANGE;
